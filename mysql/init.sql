...
-- john.doe@mbti.local : tekelomuxo (29692d4a274c2eab88b593594465644d) <- DEFAULT PASSWORD! (ONLY BRUTEFORCEABLE ACCOUNT)
...
(6, 'MBTI2024837', 'John Doe', 'Development Week 1', 'Code review and bug fixes completed.', FALSE, 'approved'),
...
(11, 'MBTI2024837', 'John Doe', 'Sprint Review Week 2', 'Sprint goals achieved. User stories completed.', FALSE, 'approved'),
...
(17, 'MBTI2024837', 'John Doe', 'Code Quality Week 3', 'Code coverage increased to 85%.', FALSE, 'approved'),
